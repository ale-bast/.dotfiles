...
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, 'file:///home/axel/.local/share/qutebrowser/userscripts/*')

# Allow locally loaded documents to access other local URLs.
# Type: Bool
config.set('content.local_content_can_access_file_urls', False, 'file:///home/axel/.local/share/qutebrowser/userscripts/*')
...
# default is used.
# Type: Directory
c.downloads.location.directory = '~/Documents/Téléchargements'
...
config.bind('pw', 'spawn --userscript qute-keepassxc --key D2D6FD5EDF1D0CE9D30941B8ED5585D94520E8DE')
...
config.bind('<Alt+Shift+u>', 'spawn --userscript qute-keepassxc --key D2D6FD5EDF1D0CE9D30941B8ED5585D94520E8DE', mode='insert')
